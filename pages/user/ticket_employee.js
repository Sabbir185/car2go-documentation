                ...
                <div className='m-4'>
                    <ul className='list-disc'>
                        ...
                        <li className='my-4'>
                            ...
                            <ul className='list-disc'>
                                <li className='my-4'>
                                    <p className='border-b-[1px] border-black font-semibold text-[18px]'>
                                        1. Replay to
                                        ticket
                                    </p>
                                ...
                                <li className='my-4'>
                                    ...
                                    < img className='h-[500px] w-auto mt-4'
                                          src="/images/employee/ticket-employee/notes.png "/>
                                </li>
                                <li className='my-4'>
                                    <p className='border-b-[1px] border-black font-semibold text-[18px]'>
                                        3. Ticket Descriptions
                                    </p>
                                    Basic information of the ticket is marked by number 3. employee can see the ticket
                                    details.
                                </li>
                                <li className='my-4'>
                                    <p className='border-b-[1px] border-black font-semibold text-[18px]'>
                                    ...
                                    <p className={'text-red-400 font-semibold'}>
                                        **If ticket status is open then only user can reply to the ticket.**
                                    </p>
                                </li>
                            </ul>
                        </li>
